 ...
 * @method static \Fabricate\Cache\CacheRepository build(array $config)
 * @method static \Fabricate\Cache\CacheRepository repository(\Fabricate\Contracts\Cache\Store $store, array $config = [])
 ...
 * @see \Fabricate\Cache\CacheRepository
 */
