 ...
 * @method static \Fabricate\Log\LogManager setApplication(\Fabricate\Contracts\Core\Program $app)
 * @method static void write(string $level, \Fabricate\NutsAndBolts\Contracts\Arrayable|\Fabricate\NutsAndBolts\Contracts\Jsonable|\Fabricate\NutsAndBolts\Stringable|array|string $message, array $context = [])
