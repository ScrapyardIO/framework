...
use Fabricate\Contracts\Queue\PreparesForDispatch;
use Fabricate\Contracts\Queue\ShouldBeUnique;
use Fabricate\Core\Queue\InteractsWithUniqueJobs;
use Fabricate\Queue\Attributes\DebounceFor;
...
class PendingDispatch
{
    ...
    protected function shouldDispatch()
    {
        ...
        return (new UniqueLock(Chassis::getInstance()->make(Cache::class)))
            ->acquire($this->job);
    }
    ...
    protected function acquireDebounceLock()
    {
        ...
        $lock = new DebounceLock(Chassis::getInstance()->make(Cache::class));
