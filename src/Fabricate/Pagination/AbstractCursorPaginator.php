...
namespace Fabricate\Pagination;
...
use Fabricate\Http\Resources\Json\JsonResource;
 ...
 *
 * @mixin \Fabricate\NutsAndBolts\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Htmlable, Stringable
{
     ...
     *
     * @var \Fabricate\NutsAndBolts\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \Fabricate\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     *
     * @param  \Fabricate\Pagination\Cursor|null  $cursor
     * @return string
     */
     ...
     *
     * @return \Fabricate\Pagination\Cursor|null
     */
     ...
     * @param  bool  $isNext
     * @return \Fabricate\Pagination\Cursor
     */
     ...
     *
     * @return \Fabricate\NutsAndBolts\Collection<TKey, TValue>
     */
     ...
     * @template TSetValue
     *
     * @param  \Fabricate\NutsAndBolts\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
