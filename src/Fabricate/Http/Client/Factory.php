...
/**
 * @mixin \Fabricate\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @var list<array{0: \Fabricate\Http\Client\Request, 1: \Fabricate\Http\Client\Response|null}>
     */
    protected $recorded = [];
     ...
     *
     * @var list<\Fabricate\Http\Client\ResponseSequence>
     */
     ...
     * @param  int  $status
     * @param  array<string, mixed>  $headers
     * @return \Fabricate\Http\Client\RequestException
     */
     ...
     * @return \Closure(\Fabricate\Http\Client\Request): \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     * @return \Fabricate\Http\Client\ResponseSequence
     */
     ...
     *
     * @param  string  $url
     * @param  \Fabricate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable|int|string|array|\Fabricate\Http\Client\ResponseSequence  $callback
     * @return $this
     */
     ...
     * @param  \Fabricate\Http\Client\Response|null  $response
     * @return void
     */
     ...
     *
     * @param  callable|(\Closure(\Fabricate\Http\Client\Request, \Fabricate\Http\Client\Response|null): bool)  $callback
     * @return void
     */
     ...
     *
     * @param  list<string|(\Closure(\Fabricate\Http\Client\Request, \Fabricate\Http\Client\Response|null): bool)|callable>  $callbacks
     * @return void
     */
     ...
     *
     * @param  (\Closure(\Fabricate\Http\Client\Request, \Fabricate\Http\Client\Response|null): bool)|callable  $callback
     * @return \Fabricate\NutsAndBolts\Collection<int, array{0: \Fabricate\Http\Client\Request, 1: \Fabricate\Http\Client\Response|null}>
     */
