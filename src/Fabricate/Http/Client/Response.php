...
class Response implements ArrayAccess, Stringable
{
     ...
     *
     * @param  callable|(\Closure(\Fabricate\Http\Client\Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @return \Fabricate\Http\Client\RequestException|null
     */
     ...
     *
     * @param  int|(\Closure(int, \Fabricate\Http\Client\Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws \Fabricate\Http\Client\RequestException
     */
