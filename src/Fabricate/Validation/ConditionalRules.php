...
class ConditionalRules
{
     ...
     *
     * @var \Fabricate\Contracts\Validation\ValidationRule|\Fabricate\Contracts\Validation\InvokableRule|\Fabricate\Contracts\Validation\Rule|\Closure|array|string
     */
    protected $rules;
