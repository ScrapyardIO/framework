...
use Fabricate\Contracts\Validation\DataAwareRule;
use Fabricate\Contracts\Validation\ImplicitRule;
use Fabricate\Contracts\Validation\Rule as RuleContract;
use Fabricate\Contracts\Validation\Validator as ValidatorContract;
...
use Fabricate\NutsAndBolts\MessageBag;
use Fabricate\NutsAndBolts\Str;
use Fabricate\NutsAndBolts\ValidatedInput;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Fabricate\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Fabricate\Contracts\Chassis\ServiceContainer
     */
    protected $container;
     ...
     *
     * @var \Fabricate\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @var \Fabricate\NutsAndBolts\MessageBag
     */
    protected $messages;
     ...
     *
     * @var class-string<\Fabricate\Validation\ValidationException>
     */
     ...
     *
     * @param  \Fabricate\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @return array
     *
     * @throws \Fabricate\Validation\ValidationException
     */
     ...
     * @return ($keys is array ? array<string, mixed> : \Fabricate\NutsAndBolts\ValidatedInput)
     *
     * @throws \Fabricate\Validation\ValidationException
     */
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Fabricate\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     *
     * @return \Fabricate\NutsAndBolts\MessageBag
     */
     ...
     * @return \Fabricate\NutsAndBolts\Fluent|mixed
     */
     ...
     * @return \Fabricate\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Fabricate\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return class-string<\Fabricate\Validation\ValidationException>
     */
     ...
     *
     * @param  class-string<\Fabricate\Validation\ValidationException>  $exception
     * @return $this
     *
     ...
     *
     * @return \Fabricate\Contracts\Translation\Translator
     */
     ...
     *
     * @param  \Fabricate\Contracts\Chassis\ServiceContainer  $container
     * @return void
     */
