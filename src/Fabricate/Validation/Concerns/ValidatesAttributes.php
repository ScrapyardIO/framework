...
namespace Fabricate\Validation\Concerns;
...
use Fabricate\Validation\FakeDnsGetRecordWrapper;
use Fabricate\Validation\Rules\Exists;
use Fabricate\Validation\Rules\Unique;
use Fabricate\Validation\ValidationData;
...
trait ValidatesAttributes
{
    ...
    public function validateEmail($attribute, $value, $parameters)
    {
        ...
        $emailValidator = $this->container->make(EmailValidator::class);
    ...
    public function parseTable($table)
    {
        ...
        if (str_contains($table, '\\') && class_exists($table) && method_exists($table, 'getTable')) {
            $model = new $table;
     ...
     * @return bool
     *
     * @throws \Fabricate\NutsAndBolts\Exceptions\MathException
     */
