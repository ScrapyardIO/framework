...
class Password implements DataAwareRule, ImplicitRule, IteratorAggregate, Rule, ValidatorAwareRule
{
     ...
     *
     * @var \Fabricate\Contracts\Validation\Validator
     */
    protected $validator;
     ...
     *
     * @param  \Fabricate\Contracts\Validation\Validator  $validator
     * @return $this
     */
    ...
    public function passes($attribute, $value)
    {
        ...
        if ($this->uncompromised && ! Chassis::getInstance()->make(UncompromisedVerifier::class)->verify([
            'value' => $value,
