...
trait DatabaseRule
{
    ...
    public function resolveTableName($table)
    {
        ...
        if (class_exists($table) && method_exists($table, 'getTable')) {
            $model = new $table;
     ...
     * @param  \Fabricate\NutsAndBolts\Contracts\Arrayable|\UnitEnum|\Closure|array|string|int|bool|null  $value
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Fabricate\NutsAndBolts\Contracts\Arrayable|\UnitEnum|array|string|int  $value
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Fabricate\NutsAndBolts\Contracts\Arrayable|\BackedEnum|array  $values
     * @return $this
     */
