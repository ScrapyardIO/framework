...
use Fabricate\Contracts\Validation\InvokableRule;
use Fabricate\Contracts\Validation\Rule;
use Fabricate\Contracts\Validation\ValidationRule;
use Fabricate\Contracts\Validation\ValidatorAwareRule;
use Fabricate\Translation\CreatesPotentiallyTranslatedStrings;
...
class InvokableValidationRule implements Rule, ValidatorAwareRule
{
     ...
     *
     * @var \Fabricate\Contracts\Validation\ValidationRule|\Fabricate\Contracts\Validation\InvokableRule
     */
    protected $invokable;
     ...
     *
     * @param  \Fabricate\Contracts\Validation\ValidationRule|\Fabricate\Contracts\Validation\InvokableRule  $invokable
     */
     ...
     *
     * @param  \Fabricate\Contracts\Validation\ValidationRule|\Fabricate\Contracts\Validation\InvokableRule  $invokable
     * @return \Fabricate\Validation\InvokableValidationRule
     */
     ...
     *
     * @return \Fabricate\Contracts\Validation\ValidationRule|\Fabricate\Contracts\Validation\InvokableRule
     */
