...
class Deserializer
{
    ...
    {
        if (++$this->nodes > DeserializerLimit::MAX_NODES->value) {
            throw new InvalidArgumentException(
                'The JSON Schema is too large to deserialize; it expands beyond ['.DeserializerLimit::MAX_NODES->value.'] fragments.'
            );
        }
