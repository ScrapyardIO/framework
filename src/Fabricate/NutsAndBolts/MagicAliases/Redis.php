...
/**
 * @method static \Fabricate\Redis\Connections\Connection connection(\UnitEnum|string|null $name = null)
 * @method static \Fabricate\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \Fabricate\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \Fabricate\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \Fabricate\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \Fabricate\Redis\Connections\Connection setName(string $name)
 ...
 *
 * @see \Fabricate\Redis\RedisManager
 */
