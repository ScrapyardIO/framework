...
use Fabricate\NutsAndBolts\Testing\Fakes\EventFake;

/**
 * @method static void listen(\Fabricate\Events\QueuedClosure|callable|array|string $events, \Fabricate\Events\QueuedClosure|callable|array|string|null $listener = null)
 ...
 * @method static \Fabricate\Events\Dispatcher setQueueResolver(callable $resolver)
 * @method static \Fabricate\Events\Dispatcher setTransactionManagerResolver(callable $resolver)
 ...
 * @method static \Fabricate\Support\Testing\Fakes\EventFake except(array|string $eventsToDispatch)
 ...
 * @method static \Fabricate\Support\Collection dispatched(string $event, callable|null $callback = null)
 * @method static bool hasDispatched(string $event)
 * @method static array dispatchedEvents()
 *
 * @see \Fabricate\Events\Dispatcher
 * @see \Fabricate\Support\Testing\Fakes\EventFake
 */
class Event extends MagicAlias
{
     ...
     * @return \Fabricate\Support\Testing\Fakes\EventFake
     */
