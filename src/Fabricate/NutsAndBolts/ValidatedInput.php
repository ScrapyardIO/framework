...
use ArrayIterator;
use Fabricate\NutsAndBolts\Contracts\ValidatedData;
...
class ValidatedInput implements ValidatedData
{
     ...
     * @param  string  $key
     * @param  mixed  $default
     * @return \Fabricate\Http\UploadedFile|null
     */
    public function file($key, $default = null)
    {
        $value = $this->input($key, $default);

        return $value instanceof \Fabricate\Http\UploadedFile ? $value : $default;
    }
