...
use Fabricate\NutsAndBolts\Contracts\MessageBag as MessageBagContract;
use Fabricate\NutsAndBolts\Contracts\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider, Stringable
{
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Contracts\MessageProvider|array<string, array<string>>  $messages
     * @return $this
     */
    ...
    public function first($key = null, $format = null)
    {
        ...
        $firstMessage = Arr::first($messages, null, fn () => '');
