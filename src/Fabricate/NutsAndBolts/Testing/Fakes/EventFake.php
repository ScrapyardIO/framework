...
use Fabricate\Contracts\Events\ShouldDispatchAfterCommit;
...
class EventFake implements Dispatcher, Fake
{
     ...
     * @return bool
     */
    protected function shouldFakeEvent($eventName, $payload): bool
    {
     ...
     * @return void
     */
    protected function fakeEvent($event, $name, $arguments): void
    {
        if ($event instanceof ShouldDispatchAfterCommit && Chassis::getInstance()->bound('db.transactions')) {
            Chassis::getInstance()->make('db.transactions')
