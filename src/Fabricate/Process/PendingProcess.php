...
use Closure;
use Fabricate\Process\Exceptions\ProcessTimedOutException;
...
class PendingProcess
{
     ...
     *
     * @param  \Fabricate\Process\Factory  $factory
     */
     ...
     *
     * @throws \Fabricate\Process\Exceptions\ProcessTimedOutException
     ...
     * @param  array<array-key, string>|string|null  $command
     * @param  callable|null  $output
     * @return \Fabricate\Process\InvokedProcess
     *
     * @throws \RuntimeException
     */
     ...
     * @param  callable|null  $output
     * @param  \Closure  $fake
     * @return \Fabricate\Process\FakeInvokedProcess
     *
     * @throws \LogicException
     */
