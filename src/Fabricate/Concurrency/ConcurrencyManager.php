...
use Fabricate\NutsAndBolts\MultipleInstanceManager;
...
/**
 * @mixin \Fabricate\Contracts\Concurrency\Driver
 */
class ConcurrencyManager extends MultipleInstanceManager
{
     ...
     *
     * @return \Fabricate\Concurrency\ProcessDriver
     */
     ...
     *
     * @return \Fabricate\Concurrency\ForkDriver
     *
     ...
     *
     * @return \Fabricate\Concurrency\SyncDriver
     */
     ...
     *
     * @return \Fabricate\Concurrency\FiberDriver
     */
    ...
    /**
     * Create an instance of the pokio concurrency driver.
     *
     * @return \Fabricate\Concurrency\PokioDriver
     *
     * @throws \RuntimeException
     */
    public function createPokioDriver()
    {
        return new PokioDriver;
    }
