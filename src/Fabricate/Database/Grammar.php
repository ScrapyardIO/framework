...
abstract class Grammar
{
     ...
     *
     * @param  array<\Fabricate\Contracts\Database\Query\Expression|string>  $values
     * @return array<string>
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string|int|float  $expression
