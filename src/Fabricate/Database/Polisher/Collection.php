 ...
 *
 * @extends \Fabricate\NutsAndBolts\Collection<TKey, TModel>
 */
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     * @return ($key is (\\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>) ? static : TModel|TFindDefault)
     */
     ...
     * @return TModel
     *
     * @throws \Fabricate\Database\Polisher\ModelNotFoundException
     */
     ...
     *
     * @param  array<array-key, array|(callable(\Fabricate\Database\Polisher\Relations\Relation<*, *, *>): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Collection<int, TModel>  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, array|(callable(\Fabricate\Database\Polisher\Relations\Relation<*, *, *>): mixed)|string>  $relations
     * @return $this
     */
     ...
     * @return static
     */
    public function merge(\Fabricate\NutsAndBolts\Contracts\Arrayable|array $items): static
    {
     ...
     * @return \Fabricate\NutsAndBolts\Collection<TKey, TMapValue>|static<TKey, TMapValue>
     */
     ...
     * @return \Fabricate\NutsAndBolts\Collection<TMapWithKeysKey, TMapWithKeysValue>|static<TMapWithKeysKey, TMapWithKeysValue>
     */
     ...
     * @return static
     */
    public function intersect(\Fabricate\NutsAndBolts\Contracts\Arrayable|array $items): static
    {
     ...
     * @return static
     */
    public function only(\Fabricate\NutsAndBolts\Contracts\Enumerable|array|string $keys): static
    {
        if (is_null($keys)) {
     ...
     * @return static
     */
    public function except(\Fabricate\NutsAndBolts\Contracts\Enumerable|array $keys): static
    {
        if (is_null($keys)) {
            return new static($this->items);
        }
     ...
     * {@inheritDoc}
     *
     * @return \Fabricate\NutsAndBolts\Collection<array-key, int>
     */
    #[\Override]
    ...
    {
        return new static($this->toBase()->collapse()->all());
    }

    /**
     * {@inheritDoc}
     *
     * @return \Fabricate\NutsAndBolts\Collection<int, mixed>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Fabricate\NutsAndBolts\Collection<TModel, TKey>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Fabricate\NutsAndBolts\Collection<int, TKey>
     */
    #[\Override]
     ...
     * @template TPadValue
     *
     * @return \Fabricate\NutsAndBolts\Collection<int, TModel|TPadValue>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Fabricate\NutsAndBolts\Collection<int<0, 1>, static<TKey, TModel>>
     */
    #[\Override]
     ...
     * @template TZipValue
     *
     * @return \Fabricate\NutsAndBolts\Collection<int, \Fabricate\NutsAndBolts\Collection<int, TModel|TZipValue>>
     */
    #[\Override]
