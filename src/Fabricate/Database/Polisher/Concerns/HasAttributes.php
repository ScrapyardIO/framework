...
use Fabricate\Contracts\Database\Polisher\CastsInboundAttributes;
use Fabricate\NutsAndBolts\Contracts\Arrayable;
use Fabricate\Database\Polisher\Casts\AsArrayObject;
use Fabricate\Database\Polisher\Casts\AsCollection;
use Fabricate\Database\Polisher\Casts\AsEncryptedArrayObject;
use Fabricate\Database\Polisher\Casts\AsEncryptedCollection;
use Fabricate\Database\Polisher\Casts\AsEnumArrayObject;
use Fabricate\Database\Polisher\Casts\AsEnumCollection;
use Fabricate\Database\Polisher\Casts\Attribute;
use Fabricate\Database\Polisher\Casts\Json;
use Fabricate\Database\Polisher\InvalidCastException;
use Fabricate\Database\Polisher\JsonEncodingException;
use Fabricate\Database\Polisher\MissingAttributeException;
use Fabricate\Database\Polisher\Relations\Relation;
use Fabricate\Database\LazyLoadingViolationException;
use Fabricate\NutsAndBolts\Arr;
use Carbon\Carbon;
use Fabricate\NutsAndBolts\Collection;
use Fabricate\NutsAndBolts\Collection as BaseCollection;
use Fabricate\NutsAndBolts\Exceptions\MathException;
...
trait HasAttributes
{
     ...
     *
     * @var \Fabricate\Contracts\Encryption\Encrypter|null
     */
     ...
     * @return null
     *
     * @throws \Fabricate\Database\Polisher\MissingAttributeException
     */
     ...
     *
     * @param  \Fabricate\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     *
     * @return \Fabricate\Contracts\Encryption\Encrypter
     */
     ...
     * @return bool
     *
     * @throws \Fabricate\Database\Polisher\InvalidCastException
     */
