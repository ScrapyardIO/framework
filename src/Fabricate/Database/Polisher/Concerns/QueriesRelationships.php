...
/** @mixin \Fabricate\Database\Polisher\Builder */
trait QueriesRelationships
{
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Fabricate\Database\Polisher\Builder<TRelatedModel>): mixed)|null  $callback
     * @return $this
     *
     ...
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Fabricate\Database\Polisher\Builder<*>): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\Relation<*, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @param  (\Closure(\Fabricate\Database\Polisher\Builder<*>|\Fabricate\Database\Polisher\Relations\Relation<*, *, *>): mixed)|null  $callback
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @template TRelatedModel of \Fabricate\Database\Polisher\Model
     *
     * @param  \Fabricate\Database\Polisher\Relations\MorphTo<TRelatedModel, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Fabricate\Database\Polisher\Builder<TRelatedModel>, string): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\MorphTo<*, TDeclaringModel>  $relation
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\MorphTo<*, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @return $this
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  (\Closure(\Fabricate\Database\Polisher\Builder<TRelatedModel>): mixed)|string|array|\Fabricate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\MorphTo<*, *>|string  $relation
     * @param  \Fabricate\Database\Polisher\Model|iterable<int, \Fabricate\Database\Polisher\Model>|string|null  $model
     * @return $this
     *
     ...
     *
     * @param  \Fabricate\Database\Polisher\Relations\MorphTo<*, *>|string  $relation
     * @param  \Fabricate\Database\Polisher\Model|iterable<int, \Fabricate\Database\Polisher\Model>|string  $model
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model|\Fabricate\Database\Polisher\Collection<int, \Fabricate\Database\Polisher\Model>  $related
     * @param  string|null  $relationshipName
     * @param  string  $boolean
     * @return $this
     *
     * @throws \Fabricate\Database\Polisher\RelationNotFoundException
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model  $related
     * @param  string|null  $relationshipName
     * @return $this
     *
     * @throws \RuntimeException
     ...
     *
     * @param  string  $column
     * @param  \Fabricate\Database\Polisher\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<*>  $hasQuery
     * @param  \Fabricate\Database\Polisher\Relations\Relation<*, *, *>  $relation
     * @param  string  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<*>  $from
     * @return $this
     */
     ...
     *
     * @param  string  $relation
     * @return \Fabricate\Database\Polisher\Relations\Relation<*, *, *>
     */
