...
use Closure;
use Fabricate\Database\ClassMorphViolationException;
...
use Fabricate\Database\Polisher\PendingHasThroughRelationship;
use Fabricate\Database\Polisher\Relations\BelongsTo;
use Fabricate\Database\Polisher\Relations\BelongsToMany;
use Fabricate\Database\Polisher\Relations\HasMany;
use Fabricate\Database\Polisher\Relations\HasManyThrough;
use Fabricate\Database\Polisher\Relations\HasOne;
use Fabricate\Database\Polisher\Relations\HasOneThrough;
use Fabricate\Database\Polisher\Relations\MorphMany;
use Fabricate\Database\Polisher\Relations\MorphOne;
use Fabricate\Database\Polisher\Relations\MorphTo;
use Fabricate\Database\Polisher\Relations\MorphToMany;
...
trait HasRelationships
{
     ...
     * @return \Fabricate\Database\Polisher\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<TRelatedModel>  $query
     ...
     * @return \Fabricate\Database\Polisher\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @return \Fabricate\Database\Polisher\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @return \Fabricate\Database\Polisher\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @return \Fabricate\Database\Polisher\Relations\BelongsTo<TRelatedModel, $this>
     */
     ...
     * @return \Fabricate\Database\Polisher\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $ownerKey
     * @return \Fabricate\Database\Polisher\Relations\MorphTo<\Fabricate\Database\Polisher\Model, $this>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \Fabricate\Database\Polisher\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \Fabricate\Database\Polisher\Model
     *
     * @param  string|\Fabricate\Database\Polisher\Relations\HasMany<TIntermediateModel, covariant $this>|\Fabricate\Database\Polisher\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \Fabricate\Database\Polisher\PendingHasThroughRelationship<\Fabricate\Database\Polisher\Model, $this>
     *     : (
     *          $relationship is \Fabricate\Database\Polisher\Relations\HasMany<TIntermediateModel, $this>
     *          ? \Fabricate\Database\Polisher\PendingHasThroughRelationship<TIntermediateModel, $this, \Fabricate\Database\Polisher\Relations\HasMany<TIntermediateModel, $this>>
     *          : \Fabricate\Database\Polisher\PendingHasThroughRelationship<TIntermediateModel, $this, \Fabricate\Database\Polisher\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \Fabricate\Database\Polisher\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Fabricate\Database\Polisher\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \Fabricate\Database\Polisher\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \Fabricate\Database\Polisher\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \Fabricate\Database\Polisher\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Fabricate\Database\Polisher\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @param  class-string<TRelatedModel>  $related
     * @param  string|class-string<\Fabricate\Database\Polisher\Model>|null  $table
     * @param  string|null  $foreignPivotKey
     * @param  string|null  $relatedPivotKey
     * @param  string|null  $parentKey
     * @param  string|null  $relatedKey
     * @param  string|null  $relation
     * @return \Fabricate\Database\Polisher\Relations\BelongsToMany<TRelatedModel, $this, \Fabricate\Database\Polisher\Relations\Pivot>
     */
     ...
     * @param  \Fabricate\Database\Polisher\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\Fabricate\Database\Polisher\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \Fabricate\Database\Polisher\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \Fabricate\Database\Polisher\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \Fabricate\Database\Polisher\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \Fabricate\Database\Polisher\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \Fabricate\Database\Polisher\Model|null  $instance
     * @return string
     */
