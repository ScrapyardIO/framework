...
use Closure;
use Fabricate\Database\Polisher\Attributes\ScopedBy;
use Fabricate\Database\Polisher\Scope;
...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Fabricate\Database\Polisher\Scope|(\Closure(\Fabricate\Database\Polisher\Builder<static>): mixed)|string  $scope
     * @param  \Fabricate\Database\Polisher\Scope|(\Closure(\Fabricate\Database\Polisher\Builder<static>): mixed)|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Fabricate\Database\Polisher\Scope|string  $scope
     * @return \Fabricate\Database\Polisher\Scope|(\Closure(\Fabricate\Database\Polisher\Builder<static>): mixed)|null
     */
