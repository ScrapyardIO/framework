...
trait CanBeOneOfMany
{
     ...
     *
     * @var \Fabricate\Database\Polisher\Builder<*>|null
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<*>  $query
     ...
     *
     * @param  \Fabricate\Database\Query\JoinClause  $join
     * @return void
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<*>  $parent
     * @param  \Fabricate\Database\Polisher\Builder<*>  $subQuery
