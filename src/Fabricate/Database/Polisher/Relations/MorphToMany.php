 ...
 * @template TPivotModel of \Fabricate\Database\Polisher\Relations\Pivot = \Fabricate\Database\Polisher\Relations\MorphPivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \Fabricate\Database\Polisher\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, TPivotModel, TAccessor>
 */
class MorphToMany extends BelongsToMany
{
     ...
     *
     * @param  mixed  $ids
     * @return \Fabricate\NutsAndBolts\Collection<int, TPivotModel>
     */
