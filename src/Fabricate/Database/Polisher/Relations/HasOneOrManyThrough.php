 ...
 * @template TResult
 *
 * @extends \Fabricate\Database\Polisher\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>) ? \Fabricate\Database\Polisher\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @param  array  $columns
     * @return \Fabricate\Database\Polisher\Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>) ? \Fabricate\Database\Polisher\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \Fabricate\Database\Polisher\ModelNotFoundException<TRelatedModel>
     */
     ...
     *     ? \Fabricate\Database\Polisher\Collection<int, TRelatedModel>|TValue
     ...
     *
     * @return \Fabricate\NutsAndBolts\LazyCollection<int, TRelatedModel>
     */
