...
use Fabricate\Database\Polisher\ModelTimestampColumn;
...
use Fabricate\Database\Polisher\Relations\Concerns\InteractsWithPivotTable;
use Fabricate\Database\Query\Grammars\MySqlGrammar;
use Fabricate\Database\UniqueConstraintViolationException;
use Fabricate\NutsAndBolts\Arr;
use Fabricate\NutsAndBolts\Collection as BaseCollection;
 ...
 * @template TPivotModel of \Fabricate\Database\Polisher\Relations\Pivot = \Fabricate\Database\Polisher\Relations\Pivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \Fabricate\Database\Polisher\Relations\Relation<TRelatedModel, TDeclaringModel, \Fabricate\Database\Polisher\Collection<int, TRelatedModel&object{pivot: TPivotModel}>>
 *
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\Fabricate\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Collection<int, TRelatedModel>  $results
     ...
     *
     * @template TNewPivotModel of \Fabricate\Database\Polisher\Relations\Pivot
     *
     ...
     *
     * @param  string|\Fabricate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  string|\Fabricate\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  array  $columns
     * @return (
     *     $id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Fabricate\Database\Polisher\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     ...
     * @return TRelatedModel&object{pivot: TPivotModel}
     *
     * @throws \Fabricate\Database\Polisher\ModelNotFoundException<TRelatedModel>
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Contracts\Arrayable|array  $ids
     * @param  array  $columns
     * @return \Fabricate\Database\Polisher\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return (
     *     $id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Fabricate\Database\Polisher\Collection<int, TRelatedModel&object{pivot: TPivotModel}>|TValue
     ...
     * @param  int|null  $page
     * @return \Fabricate\Pagination\LengthAwarePaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Fabricate\Contracts\Pagination\Paginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return \Fabricate\Contracts\Pagination\CursorPaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Fabricate\NutsAndBolts\LazyCollection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @return \Fabricate\Database\Polisher\Builder<TRelatedModel>
     */
     ...
     *
     * @return \Fabricate\NutsAndBolts\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \Fabricate\NutsAndBolts\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<TRelatedModel>  $query
     * @param  \Fabricate\Database\Polisher\Builder<TDeclaringModel>  $parentQuery
     * @param  mixed  $columns
     * @return \Fabricate\Database\Polisher\Builder<TRelatedModel>
     */
    ...
    {
        return $this->pivotCreatedAt ?? $this->parent->getCreatedAtColumn() ?? ModelTimestampColumn::CREATED_AT->value;
    }
    ...
    {
        return $this->pivotUpdatedAt ?? $this->parent->getUpdatedAtColumn() ?? ModelTimestampColumn::UPDATED_AT->value;
    }
     ...
     *
     * @param  string|\Fabricate\Contracts\Database\Query\Expression  $column
     * @return string|\Fabricate\Contracts\Database\Query\Expression
     */
