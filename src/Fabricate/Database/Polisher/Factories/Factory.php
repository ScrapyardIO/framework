...
use Fabricate\NutsAndBolts\Enumerable;
...
abstract class Factory
{
     ...
     * @param  \Fabricate\NutsAndBolts\Collection|null  $states
     * @param  \Fabricate\NutsAndBolts\Collection|null  $has
     * @param  \Fabricate\NutsAndBolts\Collection|null  $for
     * @param  \Fabricate\NutsAndBolts\Collection|null  $afterMaking
     * @param  \Fabricate\NutsAndBolts\Collection|null  $afterCreating
     * @param  \UnitEnum|string|null  $connection
     * @param  \Fabricate\NutsAndBolts\Collection|null  $recycle
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Fabricate\Database\Polisher\Model|null  $parent
     * @return \Fabricate\Database\Polisher\Collection<int, TModel>|TModel
     */
     ...
     * @param  \Fabricate\Database\Polisher\Model|null  $parent
     * @return \Closure(): (\Fabricate\Database\Polisher\Collection<int, TModel>|TModel)
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Collection<int, \Fabricate\Database\Polisher\Model>  $results
     * @return void
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model|\Fabricate\NutsAndBolts\Collection|array  $model
     * @return static
     */
     ...
     *
     * @template TClass of \Fabricate\Database\Polisher\Model
     *
     ...
     *
     * @param  \Closure(TModel, \Fabricate\Database\Polisher\Model|null): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Collection  $instances
     * @return void
     */
     ...
     * @return \Fabricate\Database\Polisher\Factories\Factory<TClass>
     */
     ...
     *
     * @param  callable(class-string<\Fabricate\Database\Polisher\Model>): class-string<\Fabricate\Database\Polisher\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<TClass>  $modelName
     * @return class-string<\Fabricate\Database\Polisher\Factories\Factory<TClass>>
     */
