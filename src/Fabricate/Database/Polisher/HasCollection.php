...
use Fabricate\Database\Polisher\Attributes\CollectedBy;
use ReflectionClass;

/**
 * @template TCollection of \Fabricate\Database\Polisher\Collection
 */
trait HasCollection
{
    /**
     ...
     *
     * @param  array<array-key, \Fabricate\Database\Polisher\Model>  $models
     * @return TCollection
     */
