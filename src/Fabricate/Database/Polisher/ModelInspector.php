...
use Fabricate\Core\MagicAliases\Gate;
...
class ModelInspector
{
     ...
     *
     * @param  \Fabricate\Contracts\Core\Program  $app  The Laravel application instance.
     */
     ...
     *
     * @param  class-string<\Fabricate\Database\Polisher\Model>|string  $model
     * @param  string|null  $connection
     * @return array{"class": class-string<\Fabricate\Database\Polisher\Model>, database: string, table: string, policy: class-string|null, attributes: \Fabricate\NutsAndBolts\Collection, relations: \Fabricate\NutsAndBolts\Collection, events: \Fabricate\NutsAndBolts\Collection, observers: \Fabricate\NutsAndBolts\Collection, collection: class-string<\Fabricate\Database\Polisher\Collection<\Fabricate\Database\Polisher\Model>>, builder: class-string<\Fabricate\Database\Polisher\Builder<\Fabricate\Database\Polisher\Model>>, "resource": class-string<\Fabricate\Http\Resources\Json\JsonResource>|null}
     *
     * @throws \Fabricate\Contracts\Chassis\BindingResolutionException
     */
    public function inspect($model, $connection = null)
    {
        $class = $this->qualifyModel($model);

        /** @var \Fabricate\Database\Polisher\Model $model */
     ...
     * @return \Fabricate\NutsAndBolts\Collection<int, array<string, mixed>>
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model  $model
     * @return class-string<\Fabricate\Database\Polisher\Collection>
     */
     ...
     *
     * @param  TModel  $model
     * @return class-string<\Fabricate\Database\Polisher\Builder<TModel>>
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model  $model
     * @return \Fabricate\Http\Resources\Json\JsonResource|null
     */
     ...
     *
     * @param  string  $model
     * @return class-string<\Fabricate\Database\Polisher\Model>
     *
     * @see \Fabricate\Console\GeneratorCommand
     */
