...
use Fabricate\Contracts\Routing\UrlRoutable;
...
use Fabricate\Database\Polisher\Attributes\Boot;
use Fabricate\Database\Polisher\Attributes\Initialize;
use Fabricate\Database\Polisher\Attributes\Scope as LocalScope;
use Fabricate\Database\Polisher\Attributes\UseEloquentBuilder;
...
use Fabricate\NutsAndBolts\Stringable as SupportStringable;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use Concerns\HasAttributes,
        ...
        ForwardsCalls;
    /** @use HasCollection<\Fabricate\Database\Polisher\Collection<array-key, static & self>> */
    use HasCollection;
     ...
     *
     * @var class-string<\Fabricate\Database\Polisher\Builder<*>>
     */
     ...
     *
     * @var class-string<\Fabricate\Database\Polisher\Collection<*, *>>
     */
    ...
    public static function isIgnoringTouch($class = null)
    {
        ...
        if (! get_class_vars($class)['timestamps'] || ! (new $class)->getUpdatedAtColumn()) {
            return true;
        }
     ...
     * @return $this
     *
     * @throws \Fabricate\Database\Polisher\MassAssignmentException
     */
     ...
     *
     * @param  \UnitEnum|string|null  $connection
     * @return \Fabricate\Database\Polisher\Builder<static>
     */
     ...
     * @return \Fabricate\Database\Polisher\Collection<int, static>
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<static>  $query
     * @return bool
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Collection|array|int|string  $ids
     * @return int
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Builder<static>  $builder
     * @return \Fabricate\Database\Polisher\Builder<static>
     */
     ...
     * @return \Fabricate\Database\Polisher\Builder<*>
     */
     ...
     *
     * @return class-string<\Fabricate\Database\Polisher\Builder>|false
     */
     ...
     * @return \Fabricate\Database\Polisher\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Fabricate\Database\Polisher\JsonEncodingException
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Fabricate\Database\ConnectionResolverInterface|null
     */
     ...
     * @return \Fabricate\Database\Polisher\Model|null
     */
     ...
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Fabricate\Database\Polisher\Relations\Relation<\Fabricate\Database\Polisher\Model, $this, *>
     */
     ...
     * Retrieve the model for a bound value.
     *
     * @param  \Fabricate\Database\Polisher\Model|\Fabricate\Contracts\Database\Polisher\Builder|\Fabricate\Database\Polisher\Relations\Relation  $query
     * @param  mixed  $value
     * @param  string|null  $field
     * @return \Fabricate\Contracts\Database\Polisher\Builder
     */
