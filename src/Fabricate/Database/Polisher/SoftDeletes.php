...
/**
 * @method static \Fabricate\Database\Polisher\Builder<static> withTrashed(bool $withTrashed = true)
 * @method static \Fabricate\Database\Polisher\Builder<static> onlyTrashed()
 * @method static \Fabricate\Database\Polisher\Builder<static> withoutTrashed()
...
trait SoftDeletes
{
     ...
     *
     * @param  \Fabricate\Events\QueuedClosure|callable|class-string  $callback
     * @return void
     */
