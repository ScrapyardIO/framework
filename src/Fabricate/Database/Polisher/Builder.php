...
use Closure;
use Exception;
use Fabricate\Contracts\Database\Polisher\Builder as BuilderContract;
use Fabricate\Contracts\Database\Query\Expression;
use Fabricate\NutsAndBolts\Contracts\Arrayable;
use Fabricate\Database\Concerns\BuildsQueries;
use Fabricate\Database\Polisher\Concerns\QueriesRelationships;
use Fabricate\Database\Polisher\Relations\BelongsToMany;
use Fabricate\Database\Polisher\Relations\Relation;
use Fabricate\Database\Query\Builder as QueryBuilder;
 ...
 *
 * @mixin \Fabricate\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Fabricate\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Fabricate\Database\Query\Builder
     */
    protected $query;
     ...
     * @param  \Fabricate\Database\Polisher\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Polisher\Scope|string  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Fabricate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Fabricate\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Fabricate\Database\Polisher\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>) ? \Fabricate\Database\Polisher\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Fabricate\Database\Polisher\ModelNotFoundException<TModel>
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Fabricate\NutsAndBolts\Contracts\Arrayable<array-key, mixed>|array<mixed>) ? \Fabricate\Database\Polisher\Collection<int, TModel> : TModel)
     *
     * @throws \Fabricate\Database\Polisher\ModelNotFoundException<TModel>
     */
     ...
     *     ? \Fabricate\Database\Polisher\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \Fabricate\Database\Polisher\Relations\Relation<\Fabricate\Database\Polisher\Model, TModel, *>
     */
     ...
     *
     * @return \Fabricate\NutsAndBolts\LazyCollection<int, TModel>
     */
     ...
     * @return \Fabricate\Pagination\LengthAwarePaginator<int, TModel>
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Fabricate\Pagination\Paginator<int, TModel>
     */
     ...
     * @return \Fabricate\Pagination\CursorPaginator<int, TModel>
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\Fabricate\Database\Polisher\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\Fabricate\Database\Polisher\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
     ...
     *
     * @template TModelNew of \Fabricate\Database\Polisher\Model
     *
     ...
     *
     * @param  array|\Fabricate\Contracts\Database\Query\Expression  $columns
     * @return array
     */
