...
use Fabricate\Contracts\Database\Query\Builder as BuilderContract;
use Fabricate\Contracts\Database\Query\ConditionExpression;
use Fabricate\Contracts\Database\Query\Expression as ExpressionContract;
use Fabricate\NutsAndBolts\Contracts\Arrayable;
use Fabricate\Database\Concerns\BuildsQueries;
use Fabricate\Database\Concerns\BuildsWhereDateClauses;
use Fabricate\Database\Concerns\ExplainsQueries;
use Fabricate\Database\ConnectionInterface;
use Fabricate\Database\Polisher\Builder as EloquentBuilder;
use Fabricate\Database\Polisher\Relations\Relation;
use Fabricate\Database\PostgresConnection;
use Fabricate\Database\Query\Grammars\Grammar;
use Fabricate\Database\Query\Processors\Processor;
use Fabricate\Pagination\Paginator;
...
{
    /** @use \Fabricate\Database\Concerns\BuildsQueries<\stdClass> */
     ...
     *
     * @var \Fabricate\Database\ConnectionInterface
     */
    public $connection;
     ...
     *
     * @var \Fabricate\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Fabricate\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @var array{
     *     function: string,
     *     columns: array<\Fabricate\Contracts\Database\Query\Expression|string>
     * }|null
     */
    public $aggregate;
     ...
     *
     * @var array<string|\Fabricate\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \Fabricate\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Fabricate\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $expression
     * @param  string  $as
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $column
     * @param  \Fabricate\NutsAndBolts\Collection<int, float>|\Fabricate\NutsAndBolts\Contracts\Arrayable|array<int, float>|string  $vector
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>|\Fabricate\Contracts\Database\Query\Expression|string  $table
     * @param  string|null  $as
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Fabricate\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Fabricate\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $table
     * @return \Fabricate\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $table
     * @return \Fabricate\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Fabricate\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Fabricate\NutsAndBolts\Contracts\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Fabricate\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Fabricate\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>|\Fabricate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @param  array{\Fabricate\Contracts\Database\Query\Expression|string, \Fabricate\Contracts\Database\Query\Expression|string}  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Fabricate\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \Fabricate\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>|\Fabricate\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $column
     * @param  \Fabricate\NutsAndBolts\Collection<int, float>|\Fabricate\NutsAndBolts\Contracts\Arrayable|array<int, float>  $vector
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|\Fabricate\Contracts\Database\Query\Expression|array<string|\Fabricate\Contracts\Database\Query\Expression>  $columns
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\Fabricate\Contracts\Database\Query\Expression|array<string|\Fabricate\Contracts\Database\Query\Expression>  $columns
     ...
     * @return mixed
     *
     * @throws \Fabricate\Database\RecordsNotFoundException
     * @throws \Fabricate\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string|\Fabricate\Contracts\Database\Query\Expression|array<string|\Fabricate\Contracts\Database\Query\Expression>  $columns
     * @return \Fabricate\NutsAndBolts\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Collection  $items
     ...
     * @return \Fabricate\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Fabricate\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Fabricate\Pagination\Cursor|string|null  $cursor
     * @return \Fabricate\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array<string|\Fabricate\Contracts\Database\Query\Expression>  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  array<string|\Fabricate\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\Fabricate\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \Fabricate\NutsAndBolts\LazyCollection<int, \stdClass>
     */
     ...
     * @return \Fabricate\NutsAndBolts\Collection<array-key, mixed>
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Query\Expression|string  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  string  $function
     * @param  array<\Fabricate\Contracts\Database\Query\Expression|string>  $columns
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @return \Fabricate\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Fabricate\Database\ConnectionInterface
     */
     ...
     *
     * @return \Fabricate\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Fabricate\Database\Query\Grammars\Grammar
     */
