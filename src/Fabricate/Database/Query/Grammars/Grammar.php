...
namespace Fabricate\Database\Query\Grammars;
...
use Fabricate\Database\Query\JoinLateralClause;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Fabricate\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\Fabricate\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
     ...
     *
     * @param  \Fabricate\Database\Query\JoinLateralClause  $join
