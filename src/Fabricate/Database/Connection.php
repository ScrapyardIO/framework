...
use Fabricate\Database\Events\StatementPrepared;
use Fabricate\Database\Events\TransactionBeginning;
use Fabricate\Database\Events\TransactionCommitted;
use Fabricate\Database\Events\TransactionCommitting;
use Fabricate\Database\Events\TransactionRolledBack;
use Fabricate\Database\Query\Builder as QueryBuilder;
use Fabricate\Database\Query\Expression;
use Fabricate\Database\Query\Grammars\Grammar as QueryGrammar;
use Fabricate\Database\Query\Processors\Processor;
use Fabricate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var (callable(\Fabricate\Database\Connection): mixed)
     */
     ...
     *
     * @var \Fabricate\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Fabricate\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @var array{has_run: bool, handler: (callable(\Fabricate\Database\Connection, class-string<\Fabricate\Database\Events\QueryExecuted>): mixed)}[]
     */
     ...
     *
     * @var (\Closure(string, array, \Fabricate\Database\Connection): mixed)[]
     */
     ...
     *
     * @return \Fabricate\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @return \Fabricate\Database\Schema\Builder
     */
     ...
     *
     * @param  \Closure|\Fabricate\Database\Query\Builder|\Fabricate\Contracts\Database\Query\Expression|\UnitEnum|string  $table
     ...
     * @return mixed
     *
     * @throws \Fabricate\Database\MultipleColumnsSelectedException
     */
     ...
     *
     * @param  (\Closure(\Fabricate\Database\Connection): mixed)  $callback
     ...
     * @return mixed
     *
     * @throws \Fabricate\Database\QueryException
     */
     ...
     * @param  (callable(\Fabricate\Database\Connection, \Fabricate\Database\Events\QueryExecuted): mixed)  $handler
     * @return void
     */
     ...
     *
     * @param  \Fabricate\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Fabricate\Database\LostConnectionException
     */
     ...
     *
     * @param  \Closure(\Fabricate\Database\Events\QueryExecuted)  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(\Fabricate\Database\Connection): mixed)  $reconnector
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Fabricate\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Fabricate\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \Fabricate\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @return \Fabricate\Contracts\Events\Dispatcher|null
     */
     ...
     *
     * @param  \Fabricate\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
