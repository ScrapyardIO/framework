...
namespace Fabricate\Database\Connectors;

use Fabricate\Chassis\Contracts\WireframeServiceContainer;
use Fabricate\Database\Connection;
use Fabricate\Database\MariaDbConnection;
use Fabricate\Database\MySqlConnection;
use Fabricate\Database\PostgresConnection;
use Fabricate\Database\SQLiteConnection;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \Fabricate\Database\Connectors\ConnectorInterface
     *
     * @throws \InvalidArgumentException
     */
