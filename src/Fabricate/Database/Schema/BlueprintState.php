...
class BlueprintState
{
     ...
     *
     * @var \Fabricate\Database\Schema\Blueprint
     */
    protected $blueprint;
     ...
     * The primary key.
     *
     * @var \Fabricate\Database\Schema\IndexDefinition|null
     */
    private $primaryKey;
     ...
     * The indexes.
     *
     * @var \Fabricate\Database\Schema\IndexDefinition[]
     */
    private $indexes;
     ...
     * The foreign keys.
     *
     * @var \Fabricate\Database\Schema\ForeignKeyDefinition[]
     */
    private $foreignKeys;
     ...
     *
     * @param  \Fabricate\Database\Schema\Blueprint  $blueprint
     ...
     * Get the primary key.
     *
     * @return \Fabricate\Database\Schema\IndexDefinition|null
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Fluent  $command
     * @return void
     */
