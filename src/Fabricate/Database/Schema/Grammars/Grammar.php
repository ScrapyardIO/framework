...
namespace Fabricate\Database\Schema\Grammars;

use Fabricate\Contracts\Database\Query\Expression;
use Fabricate\Database\Concerns\CompilesJsonPaths;
use Fabricate\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Fabricate\Database\Schema\Blueprint  $blueprint
     * @param  \Fabricate\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Fluent  $column
     * @return string
     */
     ...
     * @param  \Fabricate\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Fabricate\NutsAndBolts\Fluent|null
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Fluent|\Fabricate\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
