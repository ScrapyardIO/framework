...
use Fabricate\Database\Schema\IndexDefinition;
...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \Fabricate\Database\Schema\ForeignKeyDefinition[]  $foreignKeys
     * @return string|null
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Fluent|null  $primary
     * @return string|null
     */
