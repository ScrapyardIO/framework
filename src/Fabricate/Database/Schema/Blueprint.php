...
use Fabricate\Database\Polisher\Concerns\HasUlids;
use Fabricate\Database\Query\Expression;
use Fabricate\Database\Schema\Grammars\Grammar;
use Fabricate\Database\Schema\Grammars\MySqlGrammar;
use Fabricate\Database\Schema\Grammars\SQLiteGrammar;
...
class Blueprint
{
     ...
     *
     * @var \Fabricate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Fabricate\NutsAndBolts\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @var \Fabricate\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     *
     * @return \Fabricate\NutsAndBolts\Fluent
     */
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Fabricate\Database\Polisher\Model|string  $model
     ...
     * @return \Fabricate\Database\Schema\IndexDefinition
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Fabricate\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Fabricate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Fabricate\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  int|null  $precision
     * @return \Fabricate\NutsAndBolts\Collection<int, \Fabricate\Database\Schema\ColumnDefinition>
     */
     ...
     *
     * @param  \Fabricate\Database\Schema\ColumnDefinition  $definition
     * @return \Fabricate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \Fabricate\Database\Schema\BlueprintState
     */
