...
class Builder
{
     ...
     *
     * @var \Closure(\Fabricate\Database\Connection, string, \Closure|null): \Fabricate\Database\Schema\Blueprint
     */
    protected $resolver;
     ...
     * @return \Fabricate\Database\Schema\Blueprint
     */
    protected function createBlueprint($table, ?Closure $callback = null)
    {
        ...
        return Chassis::getInstance()->make(Blueprint::class, compact('connection', 'table', 'callback'));
    }
     ...
     *
     * @param  \Closure(\Fabricate\Database\Connection, string, \Closure|null): \Fabricate\Database\Schema\Blueprint  $resolver
     * @return void
     */
