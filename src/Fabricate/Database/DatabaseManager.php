...
use Fabricate\Database\Events\ConnectionEstablished;
use Fabricate\NutsAndBolts\Arr;
use Fabricate\NutsAndBolts\Collection;
use Fabricate\Database\ConfigurationUrlParser;
...
/**
 * @mixin \Fabricate\Database\Connection
 */
class DatabaseManager implements ConnectionResolverInterface
{
     ...
     *
     * @var \Fabricate\Database\Connectors\ConnectionFactory
     */
    protected $factory;
     ...
     *
     * @var array<string, \Fabricate\Database\Connection>
     */
     ...
     * @param  \Fabricate\Database\Connectors\ConnectionFactory  $factory
     */
     ...
     *
     * @return array<string, \Fabricate\Database\Connection>
     */
