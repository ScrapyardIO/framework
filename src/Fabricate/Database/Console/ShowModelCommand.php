...
use Fabricate\Database\Polisher\ModelInspector;
...
class ShowModelCommand extends DatabaseInspectionCommand implements PromptsForMissingInput
{
     ...
     *
     * @param  class-string<\Fabricate\Database\Polisher\Model>  $class
     * @param  string  $database
     * @param  string  $table
     * @param  class-string|null  $policy
     * @param  \Fabricate\NutsAndBolts\Collection  $attributes
     * @param  \Fabricate\NutsAndBolts\Collection  $relations
     * @param  \Fabricate\NutsAndBolts\Collection  $events
     * @param  \Fabricate\NutsAndBolts\Collection  $observers
     * @return void
     */
