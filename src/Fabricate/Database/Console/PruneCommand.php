...
use Fabricate\Database\Events\ModelPruningFinished;
use Fabricate\Database\Events\ModelPruningStarting;
use Fabricate\Database\Events\ModelsPruned;
...
class PruneCommand extends Command
{
    ...
    protected function models()
    {
        ...
        return (new Collection(Finder::create()->in($this->getPath())->files()->name('*.php')))
            ->map(function ($model) {
                $namespace = $this->scrapyard_io->getNamespace();
