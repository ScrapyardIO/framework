...
use Fabricate\Database\Events\SchemaLoaded;
use Fabricate\Database\Migrations\Migrator;
use Fabricate\Database\SQLiteDatabaseDoesNotExistException;
...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \Fabricate\Database\Migrations\Migrator
     */
    protected $migrator;
     ...
     *
     * @param  \Fabricate\Database\Migrations\Migrator  $migrator
    ...
    {
        if ($this->scrapyard_io['config']->get("database.connections.{$connection->getName()}.database") !== $connection->getDatabaseName()) {
            return false;
        }
        ...
        try {
            ...
            $this->scrapyard_io['config']->set("database.connections.{$connection->getName()}.database", $connection->getDatabaseName());
        }
    }
