...
class MigrateMakeCommand extends BaseCommand implements PromptsForMissingInput
{
     ...
     *
     * @var \Fabricate\Database\Migrations\MigrationCreator
     */
    protected $creator;
     ...
     *
     * @var \Fabricate\NutsAndBolts\Composer
     *
     ...
     *
     * @param  \Fabricate\Database\Migrations\MigrationCreator  $creator
     * @param  \Fabricate\NutsAndBolts\Composer  $composer
     */
    ...
    protected function getMigrationPath()
    {
        if (! is_null($targetPath = $this->input->getOption('path'))) {
            return ! $this->usingRealPath()
                ? $this->scrapyard_io->basePath().'/'.$targetPath
                : $targetPath;
        }
