...
use Closure;
use Fabricate\Console\View\Components\BulletList;
use Fabricate\Console\View\Components\Info;
use Fabricate\Console\View\Components\Task;
...
use Fabricate\Database\Events\MigrationEnded;
use Fabricate\Database\Events\MigrationsEnded;
use Fabricate\Database\Events\MigrationSkipped;
use Fabricate\Database\Events\MigrationsStarted;
use Fabricate\Database\Events\MigrationStarted;
use Fabricate\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var (\Closure(\Fabricate\Database\ConnectionResolverInterface, ?string): \Fabricate\Database\Connection)|null
     */
     ...
     *
     * @var array<string, \Fabricate\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \Closure(\Fabricate\Database\ConnectionResolverInterface, ?string): \Fabricate\Database\Connection  $callback
     * @return void
     */
     ...
     *
     * @return \Fabricate\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @return \Fabricate\Filesystem\Filesystem
     */
     ...
     *
     * @param  \Fabricate\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
