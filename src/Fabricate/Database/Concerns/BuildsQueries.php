...
use Fabricate\Database\RecordNotFoundException;
use Fabricate\Database\RecordsNotFoundException;
use Fabricate\Pagination\Cursor;
use Fabricate\Pagination\CursorPaginator;
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Fabricate\NutsAndBolts\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Fabricate\NutsAndBolts\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Fabricate\NutsAndBolts\LazyCollection<int, TValue>
     *
     ...
     * @return TValue
     *
     * @throws \Fabricate\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Fabricate\Database\Query\Builder|\Fabricate\Database\Polisher\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Fabricate\Pagination\Paginator
     */
     ...
     * @param  \Fabricate\NutsAndBolts\Collection  $items
     * @param  int  $perPage
     * @param  \Fabricate\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Fabricate\Pagination\CursorPaginator
     */
