...
use Closure;
use Fabricate\Bus\Events\BatchCanceled;
use Fabricate\Bus\Events\BatchFinished;
use Fabricate\Bus\Events\BatchStarted;
...
class Batch implements Arrayable, JsonSerializable
{
     ...
     *
     * @var \Fabricate\Bus\BatchRepository
     */
     ...
     *
     * @param  \Fabricate\NutsAndBolts\Enumerable|object|array  $jobs
     * @return self|null
     */
     ...
     *
     * @return \Fabricate\Bus\UpdatedBatchJobCounts
     */
