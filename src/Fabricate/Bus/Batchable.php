...
use Fabricate\NutsAndBolts\Testing\Fakes\BatchFake;
...
trait Batchable
{
     ...
     *
     * @var \Fabricate\NutsAndBolts\Testing\Fakes\BatchFake
     */
    private $fakeBatch;
     ...
     *
     * @return \Fabricate\Bus\Batch|null
     */
    public function batch()
    {
        ...
        if ($this->batchId) {
            return Chassis::getInstance()->make(BatchRepository::class)?->find($this->batchId);
        }
    }
     ...
     * @return array{0: $this, 1: \Fabricate\NutsAndBolts\Testing\Fakes\BatchFake}
     */
