...
abstract class Renderer2D extends Renderer implements DrawingSurface
{
    ...
    abstract public function setFont(object|string|null $f = null): static;
    ...
    /**
     * Bind the DisplayComponent-owned framebuffer this renderer draws into.
     * Drivers may construct unbound; factories attach before returning a component.
     */
    abstract public function useFramebuffer(Framebuffer $framebuffer): static;
     ...
     * visual output's spec so a DisplayComponent default needs no transcoding.
     */
