...
namespace BareMetal\Filesystem;
...
use ScrapyardIO\NutsAndBolts\LazyCollection;
use ScrapyardIO\NutsAndBolts\Concerns\Macroable;
use ScrapyardIO\NutsAndBolts\Concerns\Conditionable;
...
class Filesystem
{
    ...
    /**
     * Guess the file extension from the MIME type of the given file.
     * @throws RuntimeException
     */
     ...
     */
    public function isEmptyDirectory(string $directory, bool $ignore_dot_files = false): bool
    {
        return ! Finder::create()->ignoreDotFiles($ignore_dot_files)->in($directory)->depth(0)->hasResults();
    }
     ...
     */
    public function hasSameHash(string $first_file, string $second_file): bool
    {
     ...
     */
    public function files(string $directory, bool $hidden = false, array|string|int $depth = 0): array
    {
