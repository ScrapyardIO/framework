...
class BoundMethod
{
     ...
     * @throws ReflectionException
     */
    public static function call(Chassis $container, callable|string $callback, array $parameters = [], ?string $defaultMethod = null): mixed
    {
     ...
     * @throws ReflectionException
     */
    protected static function callClass(Chassis $container, string $target, array $parameters = [], ?string $defaultMethod = null): mixed
    {
     ...
     */
    protected static function callBoundMethod(Chassis $container, callable$callback, mixed $default): mixed
    {
     ...
     * @throws ReflectionException
     */
    protected static function getMethodDependencies(Chassis $container, callable|string $callback, array $parameters = []): array
    {
        $dependencies = [];
