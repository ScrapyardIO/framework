...
use BareMetal\Console\Attributes\Aliases;
use BareMetal\Console\Attributes\Description;
use BareMetal\Console\Attributes\Help;
use BareMetal\Console\Attributes\Hidden;
use BareMetal\Console\Attributes\Signature;
use BareMetal\Console\Attributes\Usage;
use BareMetal\Console\View\Components\Factory;
use BareMetal\Contracts\Chassis\Chassis;
use BareMetal\Contracts\Console\Isolatable;
...
class Command extends SymfonyCommand
{
    ...
    public function run(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->components = $this->scrapyard_io->make(Factory::class, ['output' => $this->output]);
    ...
    protected function commandIsolationMutex(): CommandMutex
    {
        return $this->scrapyard_io->bound(CommandMutex::class)
            ...
            : $this->scrapyard_io->make(CacheCommandMutex::class);
    }
