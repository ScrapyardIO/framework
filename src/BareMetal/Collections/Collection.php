...
namespace ScrpayardIO\NutsAndBolts;
...
use ScrapyardIO\NutsAndBolts\CanBeEscapedWhenCastToString;
...
class Collection implements ArrayAccess, CanBeEscapedWhenCastToString, Enumerable
{
     ...
     */
    protected function newInstance(Arrayable|iterable|null $items = []): static
    {
