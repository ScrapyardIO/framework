...
use Fabricate\Filesystem\FilesystemAdapter;
...
class FilesystemAdapterTest extends TestCase
{
    ...
    {
        $this->markTestSkipped("HTTP response helpers not ported (no incoming web / StreamedResponse).");
        // 
    ...
    {
        $this->markTestSkipped('HTTP upload/response helpers not ported for Scrapyard (no Fabricate Http / StreamedResponse).');
    ...
    public function testPutFileAs()
    {
        ...
        $uploadedFile = new SplFileInfo($filePath, 'org.txt', null, null, true);
