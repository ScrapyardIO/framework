...
class RedisConnectionTest extends TestCase
{
    ...
    public function connections()
    {
        ...
        if (isset($this->redis['predis'])) {
            $connections['predis'] = $this->redis['predis']->connection();
        }

        if (isset($this->redis['phpredis'])) {
            $connections['phpredis'] = $this->redis['phpredis']->connection();
        }

        $host = env('REDIS_HOST', '127.0.0.1');
        $port = env('REDIS_PORT', 6379);

        $connections[] = (new RedisManager(new Chassis, 'phpredis', [
            'cluster' => false,
            'default' => [
        ...
        $connections['persistent'] = (new RedisManager(new Chassis, 'phpredis', [
            'cluster' => false,
            'default' => [
                'host' => $host,
                'port' => $port,
        ...
        if (defined('Redis::COMPRESSION_LZF')) {
            $connections['compression_lzf'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
        ...
        if (defined('Redis::COMPRESSION_ZSTD')) {
            $connections['compression_zstd'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
            ...
            $connections['compression_zstd_default'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
            ...
            $connections['compression_zstd_max'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
        ...
        if (defined('Redis::COMPRESSION_LZ4')) {
            $connections['compression_lz4'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
            ...
            $connections['compression_lz4_default'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
            ...
            $connections['compression_lz4_min'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
            ...
            $connections['compression_lz4_max'] = (new RedisManager(new Chassis, 'phpredis', [
                'cluster' => false,
                'default' => [
                    'host' => $host,
                    'port' => $port,
