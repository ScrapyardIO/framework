...
use Fabricate\Contracts\Queue\Job as QueueJobContract;
use Fabricate\Queue\CallQueuedHandler;
...
class QueueWorkerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Chassis::setInstance($container = new Chassis);
